require(['common', 'echarts','echartsConfig', 'jquery', 'commonEditor', 'httpRequest', 'ace/ace', 'ace/ext/language_tools', 'echartsLiquidFill'], function (common, echarts, echartsConfig, $, commonEditor, http, ace) {
  console.log(ace)
  ...
  var option = {
    title: {
      text: chartTitle ? chartTitle : '水球图',
      left: 'center',
